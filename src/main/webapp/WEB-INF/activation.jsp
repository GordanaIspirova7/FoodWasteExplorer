...
if(window.history && history.pushState){ // check for history api support
  ...
  <form:form method="POST" commandName="activateUser" action="activateUser1" >
...
<tr>
   <td colspan="2" style="text-align: center;">
      ...
      <footer class="navbar navbar-default navbar-static-bottom footer" style="position: fixed;">
