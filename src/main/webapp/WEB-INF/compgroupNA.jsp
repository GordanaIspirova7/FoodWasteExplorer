...
document.addEventListener("click", function(evt) {  
    var div = document.getElementById('dropdown-content'),
        ...
        <div style="float:left;">
            <form:form method="POST" commandName="user" action="foodwasteHomecompgroupNA" >
  ...
  <li id="dropdown" class="dropdown" >
       ...
       <ul class="nav dropdown-content" id="dropdown-content">
        ...
        <li>
            <form:form method="POST" commandName="editUser" action="editUsercompgroupNA" >
  ...
  <form:form method="POST" commandName="commandcg"  action="compgroup">
    ...
    <div class="mainselect" >
  <form:form method="POST" commandName="component" action="componentHome1">
           ...
           <div class="row  container style-6 available" style="margin: auto; margin-top:2%; margin-bottom:1%;" >
            <div>
                   
                 <form:form  method="GET" commandName="commandNA" action="entered1">
           <form:input class="hide"  path="compgroup" value = "<%=compgroup%>"/>
              <form:button class="btn btn-success btn" autocomplete="off" type="submit"> Available </form:button> </h4> 
                 </form:form>
             </div>
        <div>
      ...
      <c:if test="${result2.size() > 0}" >
        ...
        %>   
         ...
         <div id="table" class="table-editable container" style="margin: auto; text-align:center;">
         ...
         <tbody>
             ...
             <c:forEach items = "${result2}" var="cl">
                
                <tr>
                    <form:form method="POST" id="form2" commandname="command" action="addWastevalue2"> 
                        <form:input class="hide"   path="compid" value = "${cl.getCompid()}"/>
                        <form:input class="hide"  path="wastestream" value ="<%=wastestream%>"/>
                        
             <td >${cl.getCompsubgroup()}</td>
             <td>${cl.getCftc()}</td>   
...
{%>
         ...
         <tbody>
           ...
           <td class="edit" contenteditable="false" > N/A </td>
           <td class="edit citation" contenteditable="false" > N/A </td>
             ...
             <%}%>
              ...
              <div class="contrainer text-center" >
                   <%String value="/compgroupNA?wastestream="+wastestream+"&compgroup="+compgroup+"&foodname="+foodname; %> 
