...
<%@page import="foodwaste.domain.WsvaluePostClass"%>
...
document.addEventListener("click", function(evt) {  
    var div = document.getElementById('dropdown-content'),
        ...
        <div style="float:left;">
            ...
            <form:form method="POST" commandName="user" action="foodwasteHomeeditWastevalue"> 
  ...
  <li id="dropdown" class="dropdown" >
       ...
       <ul class="nav dropdown-content" id="dropdown-content">
        ...
        <li>
            <form:form method="POST" commandName="editUser" action="editUsereditWastevalue" >
...
<%
     ...
     //String compgroup = (String)request.getAttribute("compgroup");
     //String component = (String)httpSession.getAttribute("c");
     Double value=(Double)request.getAttribute("value");
     String unit=(String)request.getAttribute("ftc");
     String citation=(String)request.getAttribute("citation");
     Integer valueid=(Integer)request.getAttribute("valueid");
     //Integer valueid=service.getWsid(wastestream, compgroup, component);
     w1.setValueid(valueid);
     w1.setValue(value);
     w1.setEmail(email);
     w1.setFtc(unit);
     w1.setCitation(citation);
     String message=service.editWsvalue(w1);
...
//          w1.setValueid(1728);
//          w1.setValue(12.12);
//          w1.setEmail("gordana.ispirova@ijs.si");
//          w1.setFtc("kg");
//          w1.setCitation("Reference1");
//          
...
<div class="container">
    <h3 style="color:#174c87; font-size: 1.5vw;">Value edited.</h3>
</div> 
<div class="container">
   <a href="#" style="color: #95c11f; font-family: regular; font-size: 2vw;" onclick="location.href = document.referrer; return false;">Go Back </a> 
</div>
<%        }
else
{
%>
<div class="container">
    <h3 style="color:red; font-size: 1.5vw;">Something went wrong. Try again.</h3>
</div> 
<div class="container">
    <a href="#" style="color: #174c87; font-family: regular; font-size: 2vw;" onclick="location.href = document.referrer; return false;">Go Back</a>
</div>
<%
    }
%>
