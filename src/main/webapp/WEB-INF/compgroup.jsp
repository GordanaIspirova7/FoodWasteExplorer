...
document.addEventListener("click", function(evt) {  
    var div = document.getElementById('dropdown-content'),
        ...
        <div style="float:left;">
            <form:form method="POST" commandName="user" action="foodwasteHomecompgroup" >
  ...
  <li id="dropdown" class="dropdown" >
       ...
       <ul class="nav dropdown-content" id="dropdown-content">
        ...
        <li>
            <form:form method="POST" commandName="editUser" action="editUsercompgroup" >
  ...
  <form:form method="POST" commandName="component" action="componentHome">
           ...
           <div class="row  container-row style-6 available" style="margin-top:2%; margin-bottom:1%;" >
            <div>
                ...
                <a class="btn btn-success btn-md" disabled href="#" >Available</a>
             </div>
        <div>
            <form:form  method="POST" commandName="commandNA" action="notentered1">
              <form:input class="hide"  path="compgroup" value = "<%=compgroup%>"/>
              <form:button class="btn btn-success" autocomplete="off"  type="submit"> Not Available </form:button> </h4> 
                 </form:form>
    ...
    
{
        %>
         ...
         <tbody>
           ...
           <td class="edit citation" contenteditable="false">${ws.getCitation()}</td>
             ...
             <%}%>
                     ...
                     <div class="contrainer text-center" >
                          ...
                          <%String value="/compgroup?wastestream="+wastestream+"&compgroup="+compgroup+"&foodname="+foodname; %> 
