...
<%@page import="foodwaste.domain.WsvaluePostAdd"%>
...
<%
     ...
     String component = (String) httpSession.getAttribute("ftc"); 
     ...
     String unit=(String)request.getAttribute("uftc");
     String reference=(String)request.getAttribute("citation");
     String email = (String) httpSession.getAttribute("email");
    // String component=(String) httpSession.getAttribute("");
     ws.setCompid(compid);
     ws.setWastestream(wastestream);
     ws.setValue(value);
     ws.setUftc(unit);
     ws.setEmail(email);
     ws.setCitation(reference);
       
     
     String message=service.addWsvalue(ws);
...
document.addEventListener("click", function(evt) {  
    var div = document.getElementById('dropdown-content'),
        ...
        <div style="float:left;">
            <form:form method="POST" commandName="user" action="foodwasteHomeaddWastevalue" >
  ...
  <li id="dropdown" class="dropdown" >
       ...
       <ul class="nav dropdown-content" id="dropdown-content">
        ...
        <li>
            <form:form method="POST" commandName="editUser" action="editUseraddWastevalue" >
