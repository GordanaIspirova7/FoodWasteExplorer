...
<html>
   ...
   <body>
    <%
     ...
     String wsname=wastestreamname.replace(wastestreamname.substring(wastestreamname.length()-1)," ");
     ...
     wstream.setFoodid(foodid);
     wstream.setGcf(gcf);
     wstream.setNcf(ncf);
     wstream.setSpecgravity(specgravity);
     wstream.setWastestream(wsname);
     String message=service.addWastestream(wstream);
    String wastestream=request.getParameter("wastestream");
    String edible1=request.getParameter("edible");
    String ncf1=request.getParameter("ncf");
    String gcf1=request.getParameter("gcf");
    String specgravity1=request.getParameter("specgravity");
...
document.addEventListener("click", function(evt) {  
    var div = document.getElementById('dropdown-content'),
        ...
        <div style="float:left;">
            <form:form method="POST" commandName="user" action="foodwasteHomeaddWastestream" >
  ...
  <li id="dropdown" class="dropdown" >
       ...
       <ul class="nav dropdown-content" id="dropdown-content">
        ...
        <li>
            <form:form method="POST" commandName="editUser" action="editUseraddWastestream" >
...
<% if((wastestream.equals(""))){%>

<div class="container" style="color:red; font-size: 1.5vw; font-family: regular;">Please enter waste stream name!</div> 
<div class="container">
